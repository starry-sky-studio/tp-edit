...
import { HeadingTwoIcon } from '@/components/ui/tiptap-icons/heading-two-icon'
import { HeadingThreeIcon } from '@/components/ui/tiptap-icons/heading-three-icon'
import { HeadingFourIcon } from '@/components/ui/tiptap-icons/heading-four-icon'
import { HeadingFiveIcon } from '@/components/ui/tiptap-icons/heading-five-icon'
import { HeadingSixIcon } from '@/components/ui/tiptap-icons/heading-six-icon'
